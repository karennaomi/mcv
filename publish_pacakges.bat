...
move LM.Core.Repository\NugetReleases\*.nupkg LM.Core.Repository\NugetReleases\old
nuget pack LM.Core.Repository\LM.Core.Repository.csproj -Prop Configuration=Release -OutputDirectory LM.Core.Repository\NugetReleases
nuget push -Source http://nuget.smv.br -ApiKey 648CA9AC80FE4CAFA2E581E0FEADCC26 LM.Core.Repository\NugetReleases\*.nupkg
