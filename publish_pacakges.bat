...
.nuget\nuget pack LM.Core.Domain\LM.Core.Domain.csproj -Prop Configuration=Release -OutputDirectory LM.Core.Domain\NugetReleases
...
.nuget\nuget pack LM.Core.Application\LM.Core.Application.csproj -Prop Configuration=Release -OutputDirectory LM.Core.Application\NugetReleases
...
.nuget\nuget pack LM.Core.RepositorioEF\LM.Core.RepositorioEF.csproj -Prop Configuration=Release -OutputDirectory LM.Core.RepositorioEF\NugetReleases
