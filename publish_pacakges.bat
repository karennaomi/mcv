...
nuget pack LM.Core.Domain\LM.Core.Domain.csproj -Prop Configuration=Debug -OutputDirectory LM.Core.Domain\NugetReleases
...
nuget pack LM.Core.Application\LM.Core.Application.csproj -Prop Configuration=Debug -OutputDirectory LM.Core.Application\NugetReleases
...
nuget pack LM.Core.RepositorioEF\LM.Core.RepositorioEF.csproj -Prop Configuration=Debug -OutputDirectory LM.Core.RepositorioEF\NugetReleases
