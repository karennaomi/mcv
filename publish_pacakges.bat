...
nuget push -Source http://nuget.listamagica.local -ApiKey 648CA9AC80FE4CAFA2E581E0FEADCC26 LM.Core.Domain\Releases\*.nupkg
...
nuget push -Source http://nuget.listamagica.local -ApiKey 648CA9AC80FE4CAFA2E581E0FEADCC26 LM.Core.Application\Releases\*.nupkg
...
nuget push -Source http://nuget.listamagica.local -ApiKey 648CA9AC80FE4CAFA2E581E0FEADCC26 LM.Core.Repository\Releases\*.nupkg